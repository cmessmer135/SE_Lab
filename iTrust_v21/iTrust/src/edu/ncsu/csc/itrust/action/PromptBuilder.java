...
public class PromptBuilder {
	public static String BuildPrompt(String comment, String oldDate, List<ApptBean> open, AddApptRequestAction action, String apptType, SimpleDateFormat frmt, long hcpid) throws SQLException, DBException {
		
		String prompt="<br/>The following nearby time slots are available:<br/>";
		int index = 0;
